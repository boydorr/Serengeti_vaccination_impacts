...
model <- readRDS("output/incidence_from_vax_model_district_stan.rds")
model_wo_incidence <- readRDS("output/incidence_from_vax_model_district_stan_woPriorCases.rds")
model_standardise <- readRDS("output/incidence_from_vax_model_district_stan_standardise.rds")
model_wo_incidence_standardise <- readRDS("output/incidence_from_vax_model_district_stan_woPriorCases_standardise.rds")

...
a<-1; lines(C,C/(1+C^a)^(1/a),col="orange")
a<-3; lines(C,C/(1+C^a)^(1/a),col="blue3")
a<-6; lines(C,C/(1+C^a)^(1/a),col=1,lwd=2)
a<-9; lines(C,C/(1+C^a)^(1/a),col="purple")
legend(0.03,1.225,paste("a =",c(1,3,6,9)),col=c("orange","blue3",1,"purple"),lwd=c(1,1,2,1),cex=0.8,bg="white")

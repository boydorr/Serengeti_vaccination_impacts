...
percent_dogs_vax <- round((n_dogs_vax_dist/dogs_dist_annual[1:length(n_dogs_vax_dist)])*100)
...
table(exposures_CT$Attacking.species)/nrow(exposures_CT)
...
sort(round((table(exposures_CT$species[which(!exposures_CT$species%in%c("Domestic dog","","dog/wildlife?"))])/nrow(exposures_CT[which(!exposures_CT$species%in%c("Domestic dog","","dog/wildlife?")),]))*100,1))
round((sum(grepl("Livestock",exposures_CT$species))/nrow(exposures_CT[which(!exposures_CT$species%in%c("Domestic dog","","dog/wildlife?")),]))*100,1)
round((sum((!(grepl("Livestock",exposures_CT$species)|exposures_CT$species=="Human"|exposures_CT$species%in%c("Domestic dog","","dog/wildlife?")|exposures_CT$species=="Cat")))/nrow(exposures_CT[which(!exposures_CT$species%in%c("Domestic dog","","dog/wildlife?")),]))*100,1)
